...
this script you need to run the kg2-plater-setup.sh script to get your environment ready (only needs
to be done once).
Usage: bash -x kg2-plater-build.sh <kg2_version, e.g., 2.8.4> <biolink_version, e.g., 3.1.2> <neo4j_password>
'
